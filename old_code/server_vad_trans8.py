...
DEFAULT_CONFIG = {
    "whisper": { 
        ...
        "initial_prompt": None # [추가] 프롬프트 기본값
    },
    "vad": { 
                ...
                if msg.type == web.WSMsgType.BINARY:
                    ...
                    while len(buf) >= BYTES_PER_FRAME:
                        ...
                        if chunk:
                            ...
                            # [수정] transcribe 호출 시 client_whisper_opts 사용
                    ...
                    if data.get("type") == "get_config": await send_config()
                        ...
                        # [수정] whisper 설정 변경 시 client_whisper_opts 업데이트
