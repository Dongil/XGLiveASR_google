...
async def ws_handler(request: web.Request):
    ...
    async def send_sentence_with_translation(sentence: str):
        ...
        logging.info(f"[{log_id}] SENT (Final Sentence): {sentence}")
        ...
        logging.info(f"[{log_id}] SENT (Translation): {sentence} | Translated: {translations}")
    ...
    try:
        ...
        logging.info(f"[{log_id}] ws client disconnected")
